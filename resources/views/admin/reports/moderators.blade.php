    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">Moderators Reports</h3>
            </div>
        ...
        <div class="kt-portlet__body">
            ...
            <h3 class="text-info">Moderators</h3>
            <div id="all_report_products" class="notloaded dashboard_results" data-url="{{url('report_moderators_table')}}"></div>
