    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">Expanses Categories</h3>
            </div>
           
            <div class="kt-portlet__head-toolbar">
            	<div class="kt-portlet__head-wrapper">
                	<div class="kt-portlet__head-actions">
                	     @if(permission_checker(Auth::guard('admin')->user()->id, 'add_expanses_category'))
                    	<a href="#" class="btn btn-brand" data-toggle="modal" data-target="#NewExpanseCategory">
                    	...
                    	<h5 class="modal-title">New Expanse Category</h5>
                    	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                    	<span aria-hidden="true">&times;</span>
                    	</button>
                    	</div>
                    	<div class="modal-body">
                        	<form class="kt-form" method="post" action="{{url('expanses_categories')}}" enctype="multipart/form-data">
                				{{csrf_field()}}
                    	...
                    	@endif
                    	 @if(permission_checker(Auth::guard('admin')->user()->id, 'delete_expanses_category'))
                    	<a href="#" class="btn btn-danger" data-toggle="modal" data-target="#myModalDALL"><i class="fas fa-trash"></i> Delete</a>
                    	...
                    	<div class="modal-body">
                    	<button type="button" class="btn btn-danger" id='delete_selected_orders' task="Delete" url="{{url('expanses_categories/expanses_categories_task')}}">Delete</button>
        ...
        <div class="kt-portlet__body">
			<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_2">
				<thead>
					<tr>
            			...
            			@endif
				<th>Name</th>
				@if(permission_checker(Auth::guard('admin')->user()->id, 'edit_expanses_category') || permission_checker(Auth::guard('admin')->user()->id, 'delete_expanses_category'))
				<th>Action</th>
				@endif
			</tr>
			</thead>
			<tbody>
			    @foreach ($cats as $cat)
					...
					<td>{{$cat->title}}</td>
					@if(permission_checker(Auth::guard('admin')->user()->id, 'delete_expanses_category') || 
					permission_checker(Auth::guard('admin')->user()->id, 'edit_expanses_category'))
					<td>
						<div class="dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							    @if(permission_checker(Auth::guard('admin')->user()->id, 'edit_expanses_category'))
                    	...
                    	<div class="modal-content">
                    	<div class="modal-header">
                    	<h5 class="modal-title">Edit Expanse Category</h5>
                    	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                    	<span aria-hidden="true">&times;</span>
                    	</button>
                    	</div>
                    	<div class="modal-body">
                        	<form class="kt-form" method="post" action="{{url('expanses_categories/'.$cat->id)}}" enctype="multipart/form-data">
                				{{csrf_field()}}
						...
						<div class="modal-body">
						<form role="form" action="{{ url('/expanses_categories/'.$cat->id) }}" class="" method="POST">
