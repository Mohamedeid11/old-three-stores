...
class ExpanseCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.expanses_categories.index')->with(['cats'=>$cats]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $cat = new ExpanseCategory;
        $cat->title  = $request->title;
        $cat->save();   
        return redirect()->route('expanses_categories.index'); 
    }
    ...
    public function expanses_categories_task(Request $request)
    {
        if($request->type == 'Delete')
        {
            ...
            {
                $id = $request->items[$i];
                $user = ExpanseCategory::findorfail($id);
                $user->hide = 1;
                $user->save();
            }
        }
