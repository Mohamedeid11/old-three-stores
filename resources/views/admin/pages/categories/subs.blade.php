    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">Categories - {{$main->title}}</h3>
            </div>
						...
						<div class="modal fade" id="CreateCategry" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							...
							<div class="modal-body">
								<form class="kt-form" method="post" action="{{url('categories')}}" enctype="multipart/form-data" id="ajsuformreload">
									...
									<input type="hidden" name="cat" value="{{$main->id}}" />
			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
				<thead>
					<tr>
						<th>#</th>
						<th>Name</th>
						@if(permission_checker(Auth::guard('admin')->user()->id, 'edit_category') || permission_checker(Auth::guard('admin')->user()->id, 'delete_category'))
						<th>Action</th>
						@endif
					</tr>
				</thead>
